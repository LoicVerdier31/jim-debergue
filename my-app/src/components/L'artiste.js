      ...
      <div className="artist-bloc">
        ...
        <div className="biography">
          <div className="text">
            ...
            <p>
              Au lycée, la découverte de l’art abstrait est une révélation qui
              lui offre un espace de liberté inégalé.
            </p>
            <p>
        ...
        <div className="inspiration">
          ...
          <div className="text">
            ...
            <p>
              ...
              ce peintre autodidacte glisse progressivement vers l’abstraction
              de la nature et de la matière.
            </p>
            <p>
            ...
            <p>
              ...
              aérienne, spatiales ou microscopiques, de revêtements, de sols ou
              de coupes anatomiques.
            </p>
            <p>
              Son travail est aussi basé sur la recherche d’effets de matières,
              de jeux d’association de couleurs et de lumières.
            </p>
            <p>
              Il pousse ainsi les spectateurs à se questionner sur les
              techniques utilisées, l’origine des matériaux, et le rapport entre
        ...
        <div className="technical">
          <div className="text">
            ...
            <p>
              Les œuvres sont réalisées à base de couches successives de
              couleurs et d’aplats translucides qui ne cachent pas, mais
              laissent voir l’évolution, la transformation et le temps.{" "}
            </p>
            <p>
            ...
            <p>
              ...
              obsessionnelle, entre la liberté donnée aux évolutions des
              matériaux et leur contrôle, entre la recherche d’une esthétique
              globale et l’abondance des détails.
            </p>
            <p>
            ...
            <p>
              ...
              concentration pour contenir les substances et rester proche du
              sujet de l’œuvre.
            </p>
          </div>
          <img src="" alt="artist-technical"></img>
        </div>
        <div className="groups">
          <img src="" alt="artist-groups"></img>
          <div className="text">
            <p className="title">Oeuvres...</p>
            <p>
              La seule limite qu’il s’impose est le plan défini par les
              dimensions du support dont il se détache progressivement pour
              aller vers l’espace tridimensionnel.
            </p>
            <p>
            ...
            <p>
              les tableaux chromatiques, qui recréent des textures
              particulières, développent différentes associations de couleurs et
              de formes.
            </p>
            <p>
              les peintures de voyage, qui concentrent l’émotion, les couleurs
              et les images d’une région du monde et utilisent des matériaux
              importés.
            </p>
            <p>
